<!-- <template>
    <div class="container">
      <div class="header">
        ...
        <button @click="addCheckbox">添加选项</button>
      </div>
      <div class="content">
        <div v-for="(option, index) in options" :key="index">
          <input type="checkbox" :id="'option-' + index" />
          <label :for="'option-' + index">
            <input type="text" placeholder="请输入选项(多选)" v-model="option.text" />
          </label>
        </div>
      </div>
    </div>
  ...
  <template>
    <div class="container">
      <div class="header">
        ...
        <input type="text" placeholder="请输入问题"  class="shuru">
      ...
      <div class="content">
        <div v-for="(option, index) in options" :key="index">
          ...
          <label :for="'option-' + index">
            <input type="text" placeholder="请输入选项(单选)" v-model="option.text"  class="shuru,posi" >
          </label>
        </div>
      </div>
    </div>
